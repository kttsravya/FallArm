        ...
        while (true) {
            try {
                ...
                while (true) {
                    ...
                    System.out.println("x value is " + input.readUTF());
                    System.out.println("y value is " + input.readUTF());
                    System.out.println("z value is " + input.readUTF());
                    System.out.println("orientation");
                    System.out.println("x value is " + input.readUTF());
                    System.out.println("y value is " + input.readUTF());
                    System.out.println("z value is " + input.readUTF());
                    System.out.println(" Fall Down (Yes/No): " + input.readUTF());
